...
### 📌 Project Overview
This project demonstrates the use of SQL for analyzing sales data and extracting meaningful business insights. The dataset contains sales transaction records, and various SQL queries were written to answer business-related questions such as revenue generation, customer behavior, product performance, and sales trends.

This is one of my first SQL portfolio projects and was created to strengthen my SQL skills while working with real-world sales data.

### 🎯 Objectives

- Create and set up a sales database
- Import and manage sales data
- Perform data analysis using SQL queries
- Generate business insights from sales records
- Practice SQL concepts used in data analytics
